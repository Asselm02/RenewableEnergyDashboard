...
ui <- fluidPage(
  ...
  p("This dashboard presents global renewable energy production data (Solar, Wind, Hydro, and Total Renewables) based on data from Our World in Data. Use the tabs to view time series trends, regression analysis, or 4-year percentage changes. (Data source: Our World in Data)"),
  sidebarLayout(
    sidebarPanel(
      conditionalPanel(
