...
ui <- fluidPage(
  ...
  p("This app shows global renewable energy production trends. It includes time series and regression analyses, as well as maps displaying 4-year percentage changes in Solar, Wind, and Water production. Data source: Our World in Data."),
  sidebarLayout(
    sidebarPanel(
      conditionalPanel(
